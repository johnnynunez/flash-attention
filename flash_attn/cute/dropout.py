...
def apply_dropout_mask_per_element(
    ...
    Args:
        ...
        tScS: Coordinate tensor with same number of elements as acc_S.
              tScS[i] gives (local_row, local_col) for acc_S[i].
...
# Keep old name as alias for SM100 backward compat
